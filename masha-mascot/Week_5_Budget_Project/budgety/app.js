...
let UIController = (function () {
  ...
  let nodeListForEach = function (list, callbackF) {
  ...
  return {
    getInput: function () {
      return {
        type: document.querySelector(DOMstrings.inputType).value, //either for inc or exp
    ...
    displayMonth: function () {
      let currentDay, currentMonth, currentYear, months;
      months = [
        "January",
        "February",
        "March",
